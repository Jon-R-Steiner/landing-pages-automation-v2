...
- [ ] **Task 12: Deployment and production testing**
  ...
  - [ ] Test deployed page with FAQs (expand/collapse functionality)
  - [ ] Verify keyboard navigation on production URL
  - [ ] Test schema.org markup with Google Rich Results Test
  - [ ] Verify responsive design on production (all breakpoints)
  - [ ] Test accessibility with production build (axe DevTools scan)
  - [ ] **Run Playwright visual regression tests** (verify visuals match expected)
  - [ ] Verify mock FAQ data renders correctly in production
