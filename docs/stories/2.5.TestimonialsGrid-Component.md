...
- [x] **Task 7: Data validation and graceful handling** (AC: 1-5)
  ...
  - [x] Limit to top 5 testimonials (slice array if more than 5)
  - [x] Return null if no valid testimonials available
...
- Data validation filters invalid testimonials and limits to top 5
