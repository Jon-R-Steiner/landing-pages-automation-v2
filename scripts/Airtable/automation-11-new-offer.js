/**
 * Airtable Automation 11: Create Offer-Specific Pages When Offer Added
 *
 * PURPOSE: Automatically create NEW Pages records when a new Offer is created
 *
 ...
 * 2. Create new automation: "Create Offer Pages When Offer Added"
 ...
 * 5. Test with dummy offer + small data set first
 * 6. Activate automation when ready (or keep disabled if you prefer manual offer linking)
 *
 * PERFORMANCE:
...
console.log(`=== Automation 11: Processing Offer "${offerRecord.name}" ===`);
